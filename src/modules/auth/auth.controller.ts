import { BadRequestException, Body, Controller, Patch, Post, Req, UseGuards, Get, Param } from '@nestjs/common';
...
export class AuthController {
    ...
    async actevatedUser(@Param() param: any) {
        return await this.authService.actevatedUser(param.hash);
    }
    ...
    async updateUser(@Req() req: Request, @Body() userUpdateDto: UserUpdateDto): Promise<UserResponseDto> {
        ...
        return await this.usersService.updateUserByEmail(dataToken.user.email, userUpdateDto);
    }
}